...
const AceptarNuevaReservacion = () => {
    ...
    const { cantidadDePersonas, checkIn, checkOut, clienteReservacion, habitacionReservacion, seleccionDeCliente, seleccionDeHabitacion } = useContext(FacturaContext);
    return (
        <Paper sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', mt: '2rem' }}>
            ...
            <Typography>Cliente: {clienteReservacion.nombre}</Typography>
            ...
            <Typography>Número de habitación: {habitacionReservacion.numero}</Typography>
